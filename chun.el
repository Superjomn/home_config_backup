...
values."
  (setq-default
   ...
   dotspacemacs-configuration-layers '(rust javascript
                                            ;; javascriptpython
                                            python yaml html themes-megapack
                                            ;; ----------------------------------------------------------------
                                            ;; Example of useful layers you may want to use right away.
                                            ;; Uncomment some layer names and press <SPC f e R> (Vim style) or
                                            ;; <M-m f e R> (Emacs style) to install them.
                                            ;; ----------------------------------------------------------------
                                            helm auto-completion better-defaults emacs-lisp git
                                            markdown org (shell :variables shell-default-height
                                                                30 shell-default-position 'bottom)
                                            ycmd spell-checking syntax-checking version-control
                                            ;; company-clang
                                            ;; flycheck
                                            )
   ...
   dotspacemacs-additional-packages '(google-c-style clang-format epc dash elisp-format
                                                     ...
                                                     ;; irony related
                                                     irony irony-eldoc flycheck-irony company-irony
                                                     rtags company-rtags rtags-helm helm-rtags
                                                     flycheck-rtags
                                                     company-irony-c-headers counsel-etags
                                                     ag yapfify
...
`dotspacemacs/user-config' first."
  ...
  (require 'ox-latex)
  (add-to-list 'org-latex-classes '("beamer" "\\documentclass\[presentation\]\{beamer\}" ("\\section\{%s\}"
                                                                                          .
                                                                                          "\\section*\{%s\}")
...
PRIORITY may be one of the characters ?A, ?B, or ?C."
  ...
  (setq org-agenda-custom-commands '(("d" "Daily agenda and all TODOs" ((tags "PRIORITY=\"A\""
  ...
  (with-eval-after-load 'org (org-babel-do-load-languages 'org-babel-load-languages '((C . t))))
  ...
  (python-env-setup)
  (chun/c++-env-setup)
  (chun/setup-rtags)) ;; end user-config
...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/project/myorgs/agenda.org" "~/project/myorgs/notes.org")))
 '(org-latex-pdf-process (quote ("xelatex -interaction nonstopmode -shell-escape %f"
                                 "xelatex -interaction nonstopmode -shell-escape %f"
                                 "xelatex -interaction nonstopmode -shell-escpae %f")))
 '(org-modules (quote (org-bbdb org-bibtex org-docview org-gnus org-habit org-info org-irc org-mhe
                                org-mouse org-rmail org-w3m org-depend org-drill)))
 '(org-startup-indented t)
 '(package-selected-packages (quote (srefactor helm-rtags cargo toml-mode racer flycheck-rust
                                               rust-mode counsel-etags company-web company-tern
                                               darktooth-theme zenburn-theme zen-and-art-theme
                                               yaml-mode white-sand-theme web-mode underwater-theme
                                               ...
                                               tagedit sunny-day-theme sublime-themes
                                               ...
                                               purple-haze-theme pug-mode professional-theme
                                               planet-theme phoenix-dark-pink-theme
                                               phoenix-dark-mono-theme organic-green-theme
                                               omtose-phellack-theme oldlace-theme occidental-theme
                                               obsidian-theme noctilux-theme naquadah-theme
                                               mustang-theme monokai-theme monochrome-theme
                                               molokai-theme moe-theme minimal-theme material-theme
                                               majapahit-theme madhat2r-theme lush-theme
                                               light-soap-theme jbeans-theme jazz-theme
                                               ir-black-theme inkpot-theme heroku-theme hemisu-theme
                                               helm-css-scss hc-zenburn-theme haml-mode
                                               gruvbox-theme gruber-darker-theme grandshell-theme
                                               gotham-theme gandalf-theme flatui-theme
                                               flatland-theme farmhouse-theme exotica-theme
                                               espresso-theme emmet-mode dracula-theme django-theme
                                               autothemer darkokai-theme darkmine-theme
                                               darkburn-theme dakrone-theme cyberpunk-theme
                                               ...
                                               apropospriate-theme anti-zenburn-theme
                                               ample-zen-theme ample-theme alect-themes
                                               afternoon-theme ox-hugo livid-mode json-mode
                                               js2-refactor web-beautify skewer-mode simple-httpd
                                               json-snatcher json-reformat multiple-cursors js2-mode
                                               js-doc tern coffee-mode cmake-mode ag flycheck-rtags
                                               company-irony-c-headers company-rtags
                                               auto-complete-clang rtags cmake-ide levenshtein
                                               flycheck-irony counsel swiper ivy company-irony
                                               flyspell-correct-helm flyspell-correct ycmd
                                               request-deferred auto-dictionary irony-eldoc irony
                                               elisp-format epc ctable concurrent deferred yapfify
                                               ...
                                               clang-format google-c-style xterm-color unfill
                                               smeargle shell-pop orgit org-projectile
                                               org-category-capture org-present org-pomodoro alert
                                               log4e gntp org-mime org-download mwim multi-term
                                               mmm-mode markdown-toc markdown-mode magit-gitflow
                                               htmlize helm-gitignore helm-company helm-c-yasnippet
                                               gnuplot gitignore-mode gitconfig-mode
                                               ...
                                               flycheck-pos-tip pos-tip flycheck evil-magit magit
                                               magit-popup git-commit ghub treepy let-alist graphql
                                               with-editor eshell-z eshell-prompt-extras esh-help
                                               diff-hl company-statistics company auto-yasnippet
                                               yasnippet ac-ispell auto-complete ws-butler winum
